...
[![Codecov test coverage](https://codecov.io/gh/Kayleeli/toy.R/graph/badge.svg)](https://app.codecov.io/gh/Kayleeli/toy.R)
<!-- badges: end -->

The goal of toy.R is to is to make regular expressions more exciting!
...
You can install the development version of toy.R from [GitHub](https://github.com/) with:
